...
def create_runtime(settings: Settings) -> SandboxRuntime:
    ...
    # Deferred: opensandbox_runtime pulls in the opensandbox SDK, which a
    # docker-provider deployment never touches and shouldn't pay import cost
    # for at process startup.
