...
FOOTNOTE = (
    ...
    "is enforced by the workflow's Coverage floors step: a repo-wide floor plus "
    "a per-file 100% floor on each module that has reached it. Neither may be "
    "lowered to make a PR green.</sub>"
)
